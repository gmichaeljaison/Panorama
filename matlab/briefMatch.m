...
%
% The suppression process will select the discriminative matches.
% For more information about the suprression of the match, please refret to [1]
%
%[1]Michael Calonder, Vincent Lepetit, Christoph Strecha, and Pascal Fua. BRIEF : Binary Robust Independent Elementary Features . ECCV, 2010

if nargin<3 %default value for ratio
    ratio = .8;
end
...
% supress match between descriptors that are not distriminative.
r = D(1,:)./D(2,:); 
